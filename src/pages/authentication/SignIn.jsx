                ...
                <div>
                    ...
                    <div className='signContainer flex flex-col justify-center items-center z-[999] w-full h-full min-w-[480px] min-h-[709px] translate-y-[0%] translate-x-[0%]'>
                        ...
                        <form onSubmit={handleSubmit} 
                            ...
                            <button type="button" onClick={handleLoginOption} className=' py-[8px] buttonSign flex flex-row justify-center items-center font-netflix bg-[rgb(51,51,51,0.8)] font-medium text-body'>
                                {signWithCode}
                            </button>

...
export default function MovieSection({ trackRef, cardRef, currentIndex, cardWidth}) {
  ...
  return (
    <div className="relative">
        ...
        <div 
            // className={` ${isAnimating ? 'transition -translate-x-[1090px] duration-1000 max-x1:-translate-x-[1300px] max-x2:-translate-x-[1195px] sm:-translate-x-[750px] md:-translate-x-[1090px] lg:-translate-x-[1190px] xl:-translate-x-[1010px]': 'translate-x-[0px] duration-1000'} flex p-0 my-[20px] gap-[25px] sm:gap-[20px] md:gap-[30px] lg:gap-[36px]`}
            className={` transition-transform flex p-0 my-[20px] gap-[25px] sm:gap-[20px] md:gap-[30px] lg:gap-[36px]`}
            style={{
                transform: cardWidth &&  `translateX(-${currentIndex * cardWidth}px)`
            }}
            ref={trackRef}    
        >

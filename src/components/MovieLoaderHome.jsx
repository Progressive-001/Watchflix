...
import './MovieLoaderHome.css';

export default function MovieLoaderHome() {
        ...
        <>
            ...
            {[...Array(20)].map((_, index)=>
                ...
                <div key={index} className="card-container relative hover:cursor-pointer hover:scale-105 transition-transform duration-500 bg-black border border-gray-500 rounded-[8px]">
                    <div className="image-container w-[120px] h-[160px] sm:w-[112px] md:w-[150px] lg:w-[280px] sm:h-[152px] md:h-[220px] lg:h-[140px] rounded-[8px] overflow-hidden">
        
                        <Skeleton animation="wave" variant="overlay" className="!rounded-[8px] !bg-[#212121] black-skeleton-wave" >
                            <img
                                alt=""
